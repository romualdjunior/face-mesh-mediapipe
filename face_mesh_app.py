...
DEMO_VIDEO = 'bella porch to demo.mp4'
DEMO_IMAGE = 'demo.jpg'
...
if app_mode == 'About App':
    st.markdown('In this application we are using **MediaPipe** for creating a Face Mesh and StreamLit for creating the Web Graphical User Interface (GUI) ')
    st.markdown(
        """
    <style>
    [data-testid="stSidebar"][aria-expanded="true"] > div:first-child {
